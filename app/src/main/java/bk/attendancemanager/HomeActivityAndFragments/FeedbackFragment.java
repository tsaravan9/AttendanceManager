...
public class FeedbackFragment extends Fragment implements ScreenShotable {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        layout = inflater.inflate(R.layout.frag_home_activity_feedback_frag, container, false);
        return layout;
    }
    ...
    public void takeScreenShot() {
        Thread thread = new Thread() {
            ...
            public void run() {
                ...
                layout.draw(canvas);
                FeedbackFragment.this.bitmap = bitmap;
            }
        };

...
public class ProFragment extends Fragment implements ScreenShotable {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        layout = inflater.inflate(R.layout.frag_home_activity_pro_frag, container, false);
        return layout;
    }
    ...
    public void takeScreenShot() {
        Thread thread = new Thread() {
            ...
            public void run() {
                ...
                layout.draw(canvas);
                ProFragment.this.bitmap = bitmap;
            }
        };
